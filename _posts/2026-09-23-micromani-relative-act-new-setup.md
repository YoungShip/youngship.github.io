...
我准备将右臂当前停靠位置设为新的**软件工作原点**。截至 08:24:43，旧原点脉冲仍未变化，本次仅做只读记录，没有执行设置、回零或运动。设置后需核对新原点脉冲、更新时间及右臂相对新原点的六轴位置；若设置前机构移动，须以设置时的新鲜反馈为准。软件工作原点更新不等于机械参考点确认。在完成这项核对前，不将该位置当作新 probe 的已验收起点。
...
- 2026-09-23 的 W 和相机布置构成当时的新实验基准；9 月 24 日拟再次设置右臂 W，尚未验收为新的 probe 起点。
